...
Let $PQ$ and $PR$  be tangents from point P on circle with radius 6 to the point Q and R on circle with radius 4 .

Using the fact that angle between radius and tangent of a circle is 90\degree,
From $\triangle OPQ$
\begin{align}
\cos \theta &=\frac{4}{6}
\\
...
Angle between PQ and OP = 180\degree-(90\degree+48.5\degree) = 41.8\degree

$\therefore$ Angle between OP and OQ  is 48.5\degree and angle between PQ and OP is 41.8\degree

Now ,

\begin{align}
\vec{Q}=4\myvec{\cos \theta\\  \sin \theta}=\myvec{2.64\\2.96}
\end{align}

  Similarly,from  $\triangle OPR$,
\begin{align}
\vec{R}=\myvec{2.64\\-2.96}
\end{align}

Now, vertices of $\triangle OPQ$ and $\triangle OPR$:
\begin{align}
\vec{O}=\myvec{0\\0},\vec{P}=\myvec{6\\0},\vec{Q}=\myvec{2.64\\2.96},
\vec{R}=\myvec{2.64\\-2.96}
\end{align}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\columnwidth]{tangents.png}
