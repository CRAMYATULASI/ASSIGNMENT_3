...
\\
\vec{Q}^T Q - \vec{Q}^T P &= 0  
\\
\norm{\vec{Q}}^2 &= \vec{Q}^T P
\\
\norm{\vec{Q}}^2 &= \vec{P}^T Q  \quad \brak{\because \vec{Q}^T P = \vec{P}^T Q}
\\
\vec{P}^T Q &= 16 \quad \brak{\because \norm{\vec{Q}}^2 = 16}
\\
\myvec{6&0} Q &= 16 \quad \brak{\because \vec{P} = \myvec{6\\0} }
\\
\myvec{1&0} Q &= 2.7
\\
Q &= \myvec{2.7\\0} + \lambda \myvec{0\\1}
\\
