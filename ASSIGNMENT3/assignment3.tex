...
Using the fact that angle between radius and tangent of a circle is 90,
From $\triangle OPQ$
\begin{align}
cos \theta &=\frac{4}{6}
\\
...
Angle between PQ and OP = 180-(90+48.5) =41.8

$\therefore$ Angle between OP and OQ  is 48.5 and angle between PQ and OP is 41.8
